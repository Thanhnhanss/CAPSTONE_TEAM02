    ...
    public class UpdateInfoController : Controller
    {
        ...
        public ActionResult UpdateInfo(string id)
        {
            if (string.IsNullOrEmpty(id))
                return RedirectToAction("UpdateInfo", new { id = User.Identity.GetUserId() });
        ...
        public ActionResult Save(string id, string hovaten, string sdt, string gioitinh, string ngaysinh, string diachi)
        {
